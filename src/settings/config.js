...
module.exports = {
  ...
  owner: process.env.OWNER_ID || "1131953433134497923", // <==== BOTS OWNER ID
  guildLogs: process.env.GUILD_LOGS || "1200719403562586133", // <==== YOUR SERVER JOIN LEFT LOGS CHANNEL ID
  ...
  supportUrl: process.env.SUPPORT_URL || "https://discord.gg/GPzYFx7zfe", 
  voteUrl: process.env.VOTE_URL || "https://discord.gg/GPzYFx7zfe",
  inviteUrl: process.env.INVITE_URL || "https://discord.com/api/oauth2/authorize?client_id=1183989229953486919&permissions=40271764260928&scope=bot%20applications.commands", 
